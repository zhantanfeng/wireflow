...
func (c *managementServiceClient) Registry(ctx context.Context, in *ManagementMessage, opts ...grpc.CallOption) (*ManagementMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ManagementMessage)
	err := c.cc.Invoke(ctx, ManagementService_Registry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedManagementServiceServer) Registry(context.Context, *ManagementMessage) (*ManagementMessage, error) {
...
func _ManagementService_Registry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ManagementMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagementServiceServer).Registry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ManagementService_Registry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagementServiceServer).Registry(ctx, req.(*ManagementMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ManagementService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Registry",
			Handler:    _ManagementService_Registry_Handler,
		},
		{
