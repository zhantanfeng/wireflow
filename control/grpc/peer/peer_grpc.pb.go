...
// ListWatcherClient is the client API for ListWatcher service.
//
...
func NewListWatcherClient(cc grpc.ClientConnInterface) ListWatcherClient {
...
type ListWatcher_WatchClient = grpc.ServerStreamingClient[WatchResponse]

// ListWatcherServer is the server API for ListWatcher service.
// All implementations must embed UnimplementedListWatcherServer
...
// UnimplementedListWatcherServer must be embedded to have
...
func (UnimplementedListWatcherServer) testEmbeddedByValue()                     {}

// UnsafeListWatcherServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ListWatcherServer will
// result in compilation errors.
type UnsafeListWatcherServer interface {
	mustEmbedUnimplementedListWatcherServer()
}

func RegisterListWatcherServer(s grpc.ServiceRegistrar, srv ListWatcherServer) {
	// If the following call pancis, it indicates UnimplementedListWatcherServer was
...
func _ListWatcher_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ListWatcherServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ListWatcher_WatchServer = grpc.ServerStreamingServer[WatchResponse]

// ListWatcher_ServiceDesc is the grpc.ServiceDesc for ListWatcher service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ListWatcher_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Watch",
			Handler:       _ListWatcher_Watch_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "control/grpc/peer/peer.proto",
}
